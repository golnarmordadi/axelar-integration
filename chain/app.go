...
import (
	...
	ibcratelimitmodule "github.com/Stride-Labs/ibc-rate-limiting/ratelimit"
...
var maccPerms = map[string][]string{
	...
	min.ModuleName:                 {authtypes.Minter},
...
var (
	_ runtime.AppI            = (*SmaplechainApp)(nil)
	_ servertypes.Application = (*SmaplechainApp)(nil)
)
...
// SmaplechainApp extended ABCI application
type SmaplechainApp struct {
	*baseapp.BaseApp
...
// NewSmaplechainApp returns a reference to an initialized SmaplechainApp.
func NewSmaplechainApp(
	logger log.Logger,
	db dbm.DB,
	...
	bApp := baseapp.NewBaseApp(param.Name, logger, db, txConfig.TxDecoder(), baseAppOptions...)
	...
	wasmHooks := ibchooks.NewWasmHooks(&app.IBCHooksKeeper, nil, param.BondDenom) // the contract keeper is set later
	...
	lc08, err := wasmvm.NewVM(filepath.Join(dataDir, "08-light-client"), strings.Join(AllCapabilities(), ","), 32, false, memCacheSizeMB)
	if err != nil {
	...
	transferStack = ibcratelimitmodule.NewIBCMiddleware(app.RatelimitKeeper, transferStack)
	...
	app.ModuleManager = module.NewManager(
		...
		ibcratelimitmodule.NewAppModule(appCodec, app.RatelimitKeeper),
	)
...
func (app *SmaplechainApp) FinalizeBlock(req *abci.RequestFinalizeBlock) (*abci.ResponseFinalizeBlock, error) {
...
func (app *SmaplechainApp) setPostHandler() {
...
func (app *SmaplechainApp) Name() string { return app.BaseApp.Name() }

// PreBlocker application updates every pre block
func (app *SmaplechainApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// BeginBlocker application updates every begin block
func (app *SmaplechainApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *SmaplechainApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (a *SmaplechainApp) Configurator() module.Configurator {
	return a.configurator
}

// InitChainer application update at chain initialization
func (app *SmaplechainApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *SmaplechainApp) LoadHeight(height int64) error {
...
func (app *SmaplechainApp) LegacyAmino() *codec.LegacyAmino {
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *SmaplechainApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns SmaplechainApp's InterfaceRegistry
func (app *SmaplechainApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns SmaplechainApp's TxConfig
func (app *SmaplechainApp) TxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *SmaplechainApp) AutoCliOpts() autocli.AppOptions {
...
func (a *SmaplechainApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *SmaplechainApp) GetKey(storeKey string) *storetypes.KVStoreKey {
	return app.keys[storeKey]
}

// GetStoreKeys returns all the stored store keys.
func (app *SmaplechainApp) GetStoreKeys() []storetypes.StoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *SmaplechainApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *SmaplechainApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *SmaplechainApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *SmaplechainApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *SmaplechainApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *SmaplechainApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *SmaplechainApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *SmaplechainApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
